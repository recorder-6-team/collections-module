/*===========================================================================*\
	Create Concept_Group_Preferred_Taxon_List table
\*===========================================================================*/
IF NOT EXISTS (SELECT *
	   FROM   SysObjects 
	   WHERE  Id = Object_Id(N'dbo.Concept_Group_Preferred_Taxon_List'))
BEGIN  
	CREATE TABLE dbo.Concept_Group_Preferred_Taxon_List (
		Concept_Group_Key CHAR(16) NOT NULL
			CONSTRAINT FK_Concept_Group_Preferred_Taxon_List_Concept_Group FOREIGN KEY
			REFERENCES dbo.Concept_Group (Concept_Group_Key),
		Priority INT NOT NULL,
		Taxon_List_Key CHAR(16) NOT NULL
			CONSTRAINT FK_Concept_Group_Preferred_Taxon_List_Taxon_List FOREIGN KEY
			REFERENCES dbo.Taxon_List (Taxon_List_Key)
	)

	ALTER TABLE dbo.Concept_Group_Preferred_Taxon_List 
	ADD CONSTRAINT UQ_Concept_Group_Preferred_Taxon_List UNIQUE	(Concept_Group_Key, Taxon_List_Key)

	/*===========================================================================*\
	  Grant permissions.
	\*===========================================================================*/
	IF OBJECT_ID('dbo.Concept_Group_Preferred_Taxon_List') IS NOT NULL
	BEGIN
    	PRINT 'Setting up security on table Concept_Group_Preferred_Taxon_List'
		IF EXISTS (SELECT * FROM SYSUSERS WHERE NAME = 'R2k_AddOnly')
        	GRANT SELECT ON dbo.Concept_Group_Preferred_Taxon_List TO [R2k_AddOnly]
		IF EXISTS (SELECT * FROM SYSUSERS WHERE NAME = 'R2k_Administrator')
		BEGIN
			GRANT SELECT ON dbo.Concept_Group_Preferred_Taxon_List TO [R2k_Administrator]
			GRANT UPDATE ON dbo.Concept_Group_Preferred_Taxon_List TO [R2k_Administrator]
			GRANT INSERT ON dbo.Concept_Group_Preferred_Taxon_List TO [R2k_Administrator]
			GRANT DELETE ON dbo.Concept_Group_Preferred_Taxon_List TO [R2k_Administrator]
		END
		IF EXISTS (SELECT * FROM SYSUSERS WHERE NAME = 'R2k_FullEdit')
		BEGIN
			GRANT SELECT ON dbo.Concept_Group_Preferred_Taxon_List TO R2k_FullEdit
			GRANT UPDATE ON dbo.Concept_Group_Preferred_Taxon_List TO R2k_FullEdit
			GRANT INSERT ON dbo.Concept_Group_Preferred_Taxon_List TO R2k_FullEdit
			GRANT DELETE ON dbo.Concept_Group_Preferred_Taxon_List TO R2k_FullEdit
		END
		IF EXISTS (SELECT * FROM SYSUSERS WHERE NAME = 'R2k_ReadOnly')
			GRANT SELECT ON dbo.Concept_Group_Preferred_Taxon_List TO [R2k_ReadOnly]
		IF EXISTS (SELECT * FROM SYSUSERS WHERE NAME = 'R2k_RecordCardsOnly')
			GRANT SELECT ON dbo.Concept_Group_Preferred_Taxon_List TO [R2k_RecordCardsOnly]
		IF EXISTS (SELECT * FROM SYSUSERS WHERE NAME = 'Dev - JNCC SQL')
		BEGIN
			GRANT SELECT ON dbo.Concept_Group_Preferred_Taxon_List TO [Dev - JNCC SQL]
			GRANT UPDATE ON dbo.Concept_Group_Preferred_Taxon_List TO [Dev - JNCC SQL]
			GRANT INSERT ON dbo.Concept_Group_Preferred_Taxon_List TO [Dev - JNCC SQL]
			GRANT DELETE ON dbo.Concept_Group_Preferred_Taxon_List TO [Dev - JNCC SQL]
		END
	END
END
GO
...
SET NOCOUNT ON
	...
	BEGIN
		...
		SELECT @taxon_list_name = Item_Name
		FROM Concept_Group
	...
	inner join taxon_list_item tli 
		on tli.taxon_list_item_key = ps.taxon_list_item_key
	group by 
		ps.taxon_list_item_key, 
		ps.priority, 
