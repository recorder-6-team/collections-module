IF NOT Exists(SELECT * FROM SysColumns WHERE Name = 'Hidden' AND Id = Object_Id('QE_Template_Field'))
	ALTER TABLE QE_Template_Field
	ADD Hidden bit NOT NULL CONSTRAINT Hidden_Def DEFAULT 0 WITH VALUES
GO
IF NOT Exists(SELECT * FROM SysColumns WHERE Name = 'Locked' AND Id = Object_Id('QE_Template_Field'))
	ALTER TABLE QE_Template_Field
	ADD Locked bit NOT NULL CONSTRAINT Locked_Def DEFAULT 0 WITH VALUES
GO
ALTER TABLE [dbo].[QE_Template_Field] DROP CONSTRAINT [CK_QE_Template_Field]
GO
ALTER TABLE [dbo].[QE_Template_Field]  WITH NOCHECK ADD  CONSTRAINT [CK_QE_Template_Field] CHECK  (([General_Tab] = 1 or [Specimen_Tab] = 1 or [Hidden] = 1))
GO
ALTER TABLE [dbo].[QE_Template_Field] CHECK CONSTRAINT [CK_QE_Template_Field]
GO
...
SET NOCOUNT OFF
	...
	INSERT INTO QE_Template_Field (
		...
		Number_Type_Concept_Key, Number_Preferred, Hidden, Locked
	) VALUES (
		...
		@NumberTypeConceptKey, @NumberPreferred, @Hidden, @Locked
	)
GO
