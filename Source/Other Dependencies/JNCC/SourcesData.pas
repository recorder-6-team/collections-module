...
{===============================================================================
  TExternalRefItem
===============================================================================}
{ Reads the FFilename value from a supplied dataset.  If the field is missing,
     an error is raised }
...
begin
  ...
  begin
    iQuery.SQL.Text:='UPDATE Source_File SET File_Name = :FileName ' +
