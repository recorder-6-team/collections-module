...
{$IFDEF LANMAN_DYNAMIC_LINK}
function LmApibufCheckAPI: Boolean;
...
function LmApibufInitAPI: Boolean;
begin
  if LibHandle = 0 then LibHandle := LoadLibrary(netapi32lib);
  if LibHandle <> 0 then
  begin
...
function LmApibufFreeAPI: Boolean;
begin
