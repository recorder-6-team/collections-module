...
type
  ...
  public
    ...
    procedure SwapItems(AFirstIndex: Integer; ASecondIndex: Integer);
...
//------------------------------------------------------------------------------
procedure TIDListBox.SwapItems(AFirstIndex: Integer; ASecondIndex: Integer);
var
  lFirstItem: String;
  lFirstKey: String;
begin
  lFirstItem := Items[AFirstIndex];
  lFirstKey := StrID[AFirstIndex];
  Items[AFirstIndex] := Items[ASecondIndex];
  StrID[AFirstIndex] := StrID[ASecondIndex];
  Items[ASecondIndex] := lFirstItem;
  StrID[ASecondIndex] := lFirstKey;
end;  // TIDListBox.SwapItems
