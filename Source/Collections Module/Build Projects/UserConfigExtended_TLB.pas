...
// ************************************************************************  //
// Type Lib: F:\Collections Module\Build Projects\UserConfigExtended.tlb (1)
// LIBID: {47C35EFA-7864-4877-936D-AB83B9EEF88C}
// LCID: 0
// Helpfile: 
// HelpString: UserConfigExtended Library
// DepndLst: 
...
const
  ...
  UserConfigExtendedMajorVersion = 1;
  UserConfigExtendedMinorVersion = 0;

  LIBID_UserConfigExtended: TGUID = '{47C35EFA-7864-4877-936D-AB83B9EEF88C}';

  IID_IfrmUCEMain: TGUID = '{0BBCF8A7-7EF2-42AF-8426-E8FA7B1AD32B}';
  DIID_IfrmUCEMainEvents: TGUID = '{3B8B1756-53DA-4BD0-B441-4360FD18588A}';
  CLASS_frmUCEMain: TGUID = '{DB4D5CF8-36EF-4DAC-A79C-3EE07170E803}';
...
// *********************************************************************//
  IfrmUCEMain = interface;
  IfrmUCEMainDisp = dispinterface;
  IfrmUCEMainEvents = dispinterface;

// *********************************************************************//
// Declaration of CoClasses defined in Type Library                       
// (NOTE: Here we map each CoClass to its Default Interface)              
// *********************************************************************//
  frmUCEMain = IfrmUCEMain;
...
// *********************************************************************//
// Interface: IfrmUCEMain
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {0BBCF8A7-7EF2-42AF-8426-E8FA7B1AD32B}
// *********************************************************************//
  IfrmUCEMain = interface(IDispatch)
    ['{0BBCF8A7-7EF2-42AF-8426-E8FA7B1AD32B}']
...
// *********************************************************************//
// DispIntf:  IfrmUCEMainEvents
// Flags:     (4096) Dispatchable
// GUID:      {3B8B1756-53DA-4BD0-B441-4360FD18588A}
// *********************************************************************//
  IfrmUCEMainEvents = dispinterface
    ['{3B8B1756-53DA-4BD0-B441-4360FD18588A}']
...
// Control Name     : TfrmUCEMain
// Help String      : frmUCEMain Control
// Default Interface: IfrmUCEMain
// Def. Intf. DISP? : No
// Event   Interface: IfrmUCEMainEvents
// TypeFlags        : (34) CanCreate Control
// *********************************************************************//
  TfrmUCEMainOnKeyPress = procedure(ASender: TObject; var Key: Smallint) of object;

  TfrmUCEMain = class(TOleControl)
  private
    ...
    FOnKeyPress: TfrmUCEMainOnKeyPress;
    FOnPaint: TNotifyEvent;
    FIntf: IfrmUCEMain;
    function  GetControlInterface: IfrmUCEMain;
  protected
    procedure CreateControl;
    procedure InitControlData; override;
  public
    property  ControlInterface: IfrmUCEMain read GetControlInterface;
    property  DefaultInterface: IfrmUCEMain read GetControlInterface;
  ...
  published
    ...
    property OnKeyPress: TfrmUCEMainOnKeyPress read FOnKeyPress write FOnKeyPress;
...
procedure TfrmUCEMain.InitControlData;
const
  ...
  CControlData: TControlData2 = (
    ClassID: '{DB4D5CF8-36EF-4DAC-A79C-3EE07170E803}';
    EventIID: '{3B8B1756-53DA-4BD0-B441-4360FD18588A}';
    EventCount: 8;
...
procedure TfrmUCEMain.CreateControl;

  procedure DoCreate;
  begin
    FIntf := IUnknown(OleObject) as IfrmUCEMain;
  end;
...
function TfrmUCEMain.GetControlInterface: IfrmUCEMain;
begin
  CreateControl;
  Result := FIntf;
end;
...
procedure Register;
begin
  RegisterComponents(dtlOcxPage, [TfrmUCEMain]);
end;
